    ...
    eventBind:function () {
         $(".wrap_account_set .save").click(function () {
             ...
             if(nickname.length<1){
                 common_ops.tip("请输入符合规则的用户名 ",nickname_target);
                 return false;
             }

             if(mobile.length<1){
                 common_ops.tip("请输入符合规则的手机号 ",mobile_target);
                 return false;
             }
             ...
             if(login_name.length<1){
                 common_ops.tip("请输入符合规则的登录名 ",login_name_target);
                 return false;
             }
